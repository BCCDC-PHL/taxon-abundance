...
process abundance_top_5_kraken_subspeciation {
  ...
  script:
  """
  kraken_top_n_linelist.py ${kraken_report} -n 5 -s ${sample_id} --taxonomy-lvl ${params.subspecies_taxonomic_level} > ${sample_id}_${params.subspecies_taxonomic_level}_top_5.csv
  """

}


process kraken_abundances_subspeciation {
  ...
  output:
  tuple val(sample_id), path("${sample_id}_${params.subspecies_taxonomic_level}_kraken2_abundances.csv")

  script:
  """
  kraken_abundances.py ${kraken_report} -s ${sample_id} --taxonomy-lvl ${params.subspecies_taxonomic_level} > ${sample_id}_${params.subspecies_taxonomic_level}_kraken2_abundances.csv
  """
